...
public class SliderPreference extends DialogPreference {
	private final boolean DEFAULT_SHOW_PROGRESS_WIDGET = false;
	...
	private boolean showProgressWidget = false;
	...
	private void setup (Context context, AttributeSet attrs) {
		...
		try {
			...
			showProgressWidget = a.getBoolean(R.styleable.SliderPreference_showProgressWidget, DEFAULT_SHOW_PROGRESS_WIDGET);
		} catch (Exception e) {
			// Do nothing
		}
		a.recycle();
		...
		if (showProgressWidget)
			setWidgetLayoutResource(R.layout.slider_preference_progress_widget);
	}
	...
	protected void onBindView (View view) {
        ...
        if (showProgressWidget) {
        	progressWidget = (ProgressBar) view.findViewById(R.id.progress_bar);
        	progressWidget.setMax(SEEKBAR_RESOLUTION);
			progressWidget.setProgress( (int) (mValue * SEEKBAR_RESOLUTION) );
        }
    }
	...
	public void setValue (float value) {
		...
		if (progressWidget != null)
			progressWidget.setProgress( (int) (value * SEEKBAR_RESOLUTION) );
